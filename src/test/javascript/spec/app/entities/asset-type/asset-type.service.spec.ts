...
describe('Service Tests', () => {
    describe('AssetType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssetTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/asset-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AssetType', () => {
                service.create(new AssetType(null)).subscribe(received => {
            ...
            it('should update a AssetType', () => {
                service.update(new AssetType(123)).subscribe(received => {
