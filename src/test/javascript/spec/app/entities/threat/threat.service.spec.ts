...
describe('Service Tests', () => {
    describe('Threat Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ThreatService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/threats';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Threat', () => {
                service.create(new Threat(null)).subscribe(received => {
            ...
            it('should update a Threat', () => {
                service.update(new Threat(123)).subscribe(received => {
