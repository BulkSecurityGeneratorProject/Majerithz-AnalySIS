...
import com.empleodigital.murcia.majerithz.repository.LocationRepository;
...
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getLocationDescription()).isEqualTo(DEFAULT_LOCATION_DESCRIPTION);
    ...
    public void updateLocation() throws Exception {
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getLocationDescription()).isEqualTo(UPDATED_LOCATION_DESCRIPTION);
