...
import com.empleodigital.murcia.majerithz.domain.Department;
import com.empleodigital.murcia.majerithz.repository.DepartmentRepository;
...
public class DepartmentResourceIntTest {
    ...
    public void getAllDepartmentsWithEagerRelationshipsIsEnabled() throws Exception {
        DepartmentResource departmentResource = new DepartmentResource(departmentRepositoryMock);
